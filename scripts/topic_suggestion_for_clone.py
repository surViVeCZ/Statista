...
class DigitalLifestyle(BaseModel):
    ...
    rate_your_competence_in_searching_for_information_online: Optional[
        Literal[
            "very_good",
            "good",
    ...
    rate_your_competence_in_digital_topics_and_using_office_packages: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_in_using_email: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_specifically_in_using_social_media: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_in_using_messenger_services: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_competence_understanding_of_video_calling_apps: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_competence_in_setting_up_accounts_on_digital_platforms: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_level_in_online_shopping: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_in_problemsolving_using_faqsortutorialsorchats: (
        Optional[
            Literal[
                "very_good",
                "good",
    ...
    rate_your_understanding_of_digital_privacy: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    rate_your_digital_expertise_on_online_payment: Optional[
        Literal[
            "very_good",
            "good",
            "neither_good_nor_bad",
    ...
    are_you_planning_to_take_nonworkorschool_digital_skills_courses: Optional[
        Literal[
    ...
    which_courses_required_payment: Optional[
        Literal[
            "applying_for_jobs",
            "basic_computer_skills",
            "basic_online_skills",
    ...
    what_course_do_you_plan_to_take_in_the_next_year: Optional[
        Literal[
            "applying_for_jobs",
            "basic_computer_skills",
            "basic_online_skills",
    ...
    which_statement_do_you_agree_with: Optional[
        Literal[
    ...
    what_aspects_of_digital_privacy_apply_to_you: Optional[
        Literal[
    ...
    which_statement_about_your_online_social_interaction_do_you_agree_with: Optional[
        Literal[
    ...
    what_digital_methods_have_you_used_for_communication_recently: Optional[
        Literal[
    ...
    what_are_your_general_reasons_for_using_social_media: Optional[
        Literal[
    ...
    when_do_you_generally_use_social_media: Optional[
        Literal[
    ...
    what_activities_have_you_done_on_social_media_recently: Optional[
        Literal[
            "commented_on_posts",
            "followed_companies",
            "followed_people",
    ...
    did_you_share_opinions_on_these_topics_on_social_media_recently: Optional[
        Literal[
            "arts_and_culture",
    ...
    which_social_media_platforms_are_you_aware_of: Optional[
        Literal[
            "facebook",
            "flickr",
            "instagram",
    ...
    which_social_media_platforms_do_you_regularly_use: Optional[
        Literal[
            "facebook",
            "flickr",
            "instagram",
    ...
    frequency_of_usage_for_various_social_media_platforms: Optional[
        Literal["frequent", "occasional", "dont_know"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_the_following_social_media_platforms_Overall_usage_frequency",
    )
    how_frequently_do_you_use_facebook: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
    ...
    how_frequently_do_you_use_flickr: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_instagram: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_linkedin: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_pinterest: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_reddit: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_snapchat: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_tiktok: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_tumblr: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_twitter: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    frequency_of_wechat_usage: Optional[
        Literal["several_times_a_day", "once_a_day", "several_times_a_week"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_the_following_social_media_platforms_WeChat",
    )
    frequency_of_youtube_usage: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_quora: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    frequency_of_using_xing_social_media_platform: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    frequency_of_use_for_social_media_platform_jodel: Optional[
        Literal["several_times_a_day", "once_a_day", "several_times_a_week"]
    ] = Field(
        default=None,
    ...
    how_frequently_do_you_use_facebook: Optional[
        Literal["frequent_(daily)", "occasional"]
    ] = Field(
        default=None,
    ...
    how_frequently_do_you_use_instagram: Optional[
        Literal["frequent_(daily)", "occasional", "dont_know"]
    ] = Field(
        default=None,
    ...
    whats_your_usual_frequency_of_using_reddit: Optional[
        Literal["frequent_(daily)", "occasional"]
    ] = Field(
        default=None,
    ...
    which_digital_platforms_have_you_used_personally_recently: Optional[
        Literal["digital_platform_user", "non-user"]
    ] = Field(
        default=None,
    ...
    what_digital_platforms_are_you_aware_of_even_by_name: Optional[
        Literal[
            "discord",
            "facebook_messenger",
            "facetime",
    ...
    frequency_of_personal_use_of_video_calls: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    which_statement_about_digital_media_services_do_you_agree_with: Optional[
        Literal[
    ...
    which_digital_media_services_have_you_used_recently: Optional[
        Literal[
    ...
    when_and_where_do_you_use_digital_media_services: Optional[
        Literal[
            "in_the_bathroom/on_the_toilet",
            "while_doing_sports",
            "during_my_morning_routine",
    ...
    how_frequently_do_you_use_audiobooks_downloadorstreaming_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_ebook_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_digital_music_downloadorstreaming_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_digital_video_content_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    frequency_of_using_enewspapers_and_emagazines_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_online_radio_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_frequently_do_you_use_podcast_services: Optional[
        Literal[
            "several_times_a_day",
            "once_a_day",
            "several_times_a_week",
    ...
    how_many_weekly_hours_do_you_spend_using_audiobook_services: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_using_ebooks: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_streamingordownloading_music: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_streamingordownloading_digital_video: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_on_enewspapersoremagazines: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_on_online_radio: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_many_weekly_hours_do_you_spend_on_podcasts: Optional[
        Literal[
            "less_than_1_hour",
            "1_to_5_hours",
            "6_to_10_hours",
    ...
    how_frequently_do_you_use_media_services_like_audiobooks: Optional[
        Literal["frequent", "occasional", "dont_know"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_these_services_Media_frequency_Audiobooks",
    )
    how_many_weekly_hours_do_you_spend_on_audiobooks: Optional[
        Literal["light", "moderate", "high"]
    ] = Field(
        default=None,
        description="Approximately_how_many_hours_in_an_average_week_do_you_use_these_services_Media_intensity_Audiobooks",
    )
    what_platforms_have_you_used_for_paid_audiobooks_recently: Optional[
        Literal[
            "apple_books",
            "audible",
            "downpour",
    ...
    how_frequently_do_you_use_media_services_like_ebooks: Optional[
        Literal["frequent", "occasional", "dont_know"]
    ] = Field(
        default=None,
    ...
    what_devices_do_you_use_to_read_ebooks: Optional[
        Literal["laptop/pc", "tablet", "smartphone", "ereader"]
    ] = Field(
        default=None, description="Which_devices_do_you_normally_use_to_read_eBooks"
    )
    what_brand_is_your_ereader: Optional[
        Literal["amazon_kindle", "kobo", "pocketbook", "tolino", "other", "don’t_know"]
    ] = Field(
        default=None,
        description="You_said_you_have_an_eReader_What_brand_of_eReader_is_it",
    )
    what_type_of_ebooks_or_audiobooks_do_you_consume: Optional[
        Literal[
    ...
    how_frequently_do_you_use_digital_music_media_services: Optional[
        Literal["frequent", "occasional", "dont_know"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_these_services_Media_frequency_Digital_music",
    )
    how_many_weekly_hours_do_you_spend_using_digital_music_services: Optional[
        Literal["light", "moderate", "high", "dont_know"]
    ] = Field(
        default=None,
        description="Approximately_how_many_hours_in_an_average_week_do_you_use_these_services_Media_intensity_Digital_music",
    )
    which_music_streaming_platforms_have_you_paid_for_recently: Optional[
        Literal[
            "amazon_music",
            "apple_music",
            "deezer",
    ...
    what_music_genres_do_you_stream_or_download_digitally: Optional[
        Literal[
            "classical_music",
            "dance/electronic",
            "jazz_and_blues",
    ...
    what_video_streaming_genres_interest_you: Optional[
        Literal[
    ...
    how_frequently_do_you_use_enewspaper_services: Optional[
        Literal["frequent", "occasional"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_these_services_Media_frequency_eNewspapers",
    )
    how_many_weekly_hours_do_you_spend_on_enewspapers: Optional[
        Literal["light", "moderate", "high", "dont_know"]
    ] = Field(
        default=None,
        description="Approximately_how_many_hours_in_an_average_week_do_you_use_these_services_Media_intensity_eNewspapers",
    )
    what_type_of_content_do_you_consume_from_emagazines_and_enewspapers: Optional[
        Literal[
    ...
    how_frequently_do_you_use_media_services_like_podcasts: Optional[
        Literal["frequent", "occasional", "dont_know"]
    ] = Field(
        default=None,
        description="How_often_do_you_normally_use_these_services_Media_frequency_Podcasts",
    )
    how_many_hours_per_week_do_you_spend_on_podcasts: Optional[
        Literal["light", "moderate", "high"]
    ] = Field(
        default=None,
        description="Approximately_how_many_hours_in_an_average_week_do_you_use_these_services_Media_intensity_Podcasts",
    )
    what_platforms_have_you_used_to_streamordownload_paid_podcasts: Optional[
        Literal[
            "apple_podcasts",
            "audionow",
            "castbox",
    ...
    what_type_of_podcast_content_do_you_consume: Optional[
        Literal[
    ...
    do_you_use_another_device_while_watching_tvorvideo: Optional[
        Literal["yes", "no", "don’t_know"]
    ] = Field(
        default=None,
        description="Do_you_use_a_second_device_or_screen_while_watching_TV_or_video_content",
    )
    which_devices_do_you_usually_use_simultaneously: Optional[
        Literal[
            "desktop_pc",
    ...
    what_is_your_activity_on_the_second_device: Optional[
        Literal[
    ...
    frequency_of_your_online_product_purchases: Optional[
        Literal[
    ...
    what_products_have_you_bought_online_in_the_past_year: Optional[
        Literal[
    ...
    how_did_you_first_learn_about_products_before_online_shopping: Optional[
        Literal[
            "blog_post",
    ...
    did_you_research_online_products_before_purchasing_last_year: Optional[
        Literal[
    ...
    reasons_for_choosing_where_to_buy_products_online: Optional[
        Literal[
            "advertising",
            "availability",
    ...
    what_payment_method_did_you_use_for_online_purchases_last_year: Optional[
        Literal[
            "by_invoice",
            "cash_in_advance",
            "cash_on_delivery",
    ...
    what_online_shopping_sites_have_you_used_in_the_past_year: Optional[
        Literal[
            "amazon",
            "apple",
            "bonprix",
    ...
    which_online_payment_systems_have_you_used_in_past_year: Optional[
        Literal[
            "2checkout",
            "amazon_pay",
            "apple_pay",
    ...
    did_you_review_an_online_product_purchased_in_the_past_year: Optional[
        Literal[
    ...
    what_topics_were_covered_in_your_feedback_reviews: Optional[
        Literal[
    ...
    do_you_use_internet_on_a_device_at_a_physical_store: Optional[
        Literal[
    ...
    what_payment_methods_did_you_use_instore_last_year: Optional[
        Literal[
            "cash",
            "credit_card",
            "debit_card",
    ...
    which_statement_about_your_interests_and_hobbies_do_you_agree_with: Optional[
        Literal[
    ...
    what_do_you_do_in_your_free_time: Optional[
        Literal[
            "arts_and_crafts",
            "charity_work",
            "dancing",
    ...
    what_hobbies_or_interests_do_you_pursue_digitally: Optional[
        Literal[
            "arts_and_crafts",
            "charity_work",
            "dancing",
    ...
    question_about_digital_technologys_role_in_health_and_fitness: Optional[
        Literal[
    ...
    what_motivates_your_use_of_fitness_apps_and_trackers: Optional[
        Literal[
    ...
    which_fitness_function_smartwatches_do_you_own: Optional[
        Literal[
            "adidas",
            "amazfit",
            "apple",
    ...
    did_you_use_online_dating_in_the_past_year: Optional[
        Literal["yes", "no", "prefer_not_to_say"]
    ] = Field(
        default=None, description="Have_you_used_online_dating_in_the_past_12_months"
    )
    why_did_you_start_online_dating: Optional[
        Literal[
    ...
    which_platforms_have_you_used_in_the_past_year: Optional[
        Literal[
            "badoo",
            "bumble",
            "c-date",
    ...
    which_services_did_you_pay_for: Optional[
        Literal[
            "badoo",
            "bumble",
            "c-date",
    ...
    did_you_take_online_courses_in_these_fields_last_year: Optional[
        Literal[
    ...
    which_courses_did_you_pay_for: Optional[
        Literal[
            "lifestyle_(eg_makeup_interior_design)",
            "culinary_arts",
            "language_courses",
    ...
    have_you_worked_from_home_in_the_past_year: Optional[
        Literal["yes", "no", "i_do_not_work"]
    ] = Field(
        default=None,
        description="The_following_questions_are_about_working_from_home_Have_you_worked_from_home_in_the_past_12_months",
    )
    which_statement_about_working_from_home_do_you_agree_with: Optional[
        Literal[
    ...
    why_did_you_work_from_home_last_year: Optional[
        Literal[
    ...
    impact_of_online_and_digital_technology_on_mental_wellbeing: Optional[
        Literal["postive_impact", "negative_impact", "no_impact", "neither_/_dont_know"]
    ] = Field(
        default=None,
    ...
    impact_of_onlineordigital_technology_on_your_mental_wellbeing: Optional[
        Literal[
            "improved_it",
    ...
    whats_your_preferred_method_of_online_communication_with_companies: Optional[
        Literal[
            "via_e-mail",
    ...
    what_social_media_content_interests_you_from_brandsorcompanies: Optional[
        Literal[
            "their_employees",
            "company_news",
    ...
    how_do_you_prefer_receiving_content_from_brands_on_social_media: Optional[
        Literal[
            "videos",
            "live_videos",
            "video_stories",
    ...
    where_have_you_encountered_online_ads_recently: Optional[
        Literal[
    ...
    which_ad_made_you_click_or_seek_more_information: Optional[
        Literal[
            "advertising_videos_on_websites",
            "advertising_videos_on_youtube",
            "banner_ads_on_websites_(integrated_or_pop-ups)",
    ...
    what_devices_do_you_frequently_use_at_home: Optional[
        Literal[
            "desktop_pc",
            "gaming_console_(eg_ps4_xbox)",
            "laptop_with_touch_screen",
    ...
    what_operating_systems_do_you_use_on_your_computer: Optional[
        Literal[
            "microsoft_windows",
            "macos",
            "linux",
    ...
    what_operating_systems_do_your_mobile_devices_use: Optional[
        Literal[
            "android_os",
            "ios",
            "linux",
    ...
    what_virtual_assistants_do_you_use_with_smart_speakers: Optional[
        Literal[
            "google_assistant",
            "siri",
            "alexa",
    ...
    whats_your_preferred_registration_method_for_new_digital_services: Optional[
        Literal[
    ...
    what_account_do_you_primarily_use_for_new_digital_services: Optional[
        Literal[
            "facebook_account",
            "google_account",
            "microsoft_account",
    ...
    do_you_use_cloud_storage_solutions_personally: Optional[
        Literal[
    ...
    what_is_your_purpose_for_using_cloud_storage_services: Optional[
        Literal[
            "photos",
            "backups",
            "office_documents",
    ...
    do_you_use_servicesorsoftware_for_personal_document_creationorediting: Optional[
        Literal[
            "microsoft_office",
            "openoffice",
            "iwork",
